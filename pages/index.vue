<template>
  <div class="relative overflow-hidden">
    <main>
      ...
      <div
        class="lg:absolute lg:inset-y-0 lg:right-0 lg:w-1/2 md:h-1/5 clip rounded"
      >
        <img
          class="h-56 w-full object-cover sm:h-72 md:h-96 lg:w-full lg:h-full"
          src="https://images.unsplash.com/photo-1551434678-e076c223a692?ixlib=rb-1.2.1&ixqx=bOwupxPDeC&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=2850&q=80"
          alt=""
        />
      </div>
      ...
      <div class="relative py-16 sm:py-24 lg:py-32">
        ...
        >
          <h2
            class="text-base font-semibold tracking-wider text-primary uppercase"
          >
            <!-- Grow faster -->
            Groei sneller
          </h2>
          ...
          >
            ...
            alles wat nodig is voor een succesvolle zaak
          </p>
      ...
      <!-- Testimonial section -->
      <div class="pb-16 bg-gradient lg:pb-0 lg:z-10 lg:relative">
        <div
          class="lg:mx-auto lg:max-w-7xl lg:px-8 lg:grid lg:grid-cols-3 lg:gap-8"
        >
          <div class="relative lg:-my-8">
            <div
              class="mx-auto max-w-md px-4 py-4 sm:max-w-3xl sm:px-6 lg:p-0 lg:h-full"
            >
              <div
              ...
              >
                <img
                  ...
                  src="https://images.unsplash.com/photo-1520333789090-1afc82db536a?ixlib=rb-1.2.1&ixqx=iSkqcLULB3&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=2102&q=80"
                  alt=""
                />
              </div>
            </div>
          ...
          <div class="mt-12 lg:m-0 lg:col-span-2 lg:pl-8">
            ...
            >
              <blockquote>
                ...
                <footer class="mt-6">
                  <p class="text-base font-medium text-white">Gaëtan Onou</p>
                  <p class="text-base font-medium text-primary-100">
                    CEO at <span class="font-title">ONOU</span>
                  </p>
                </footer>
              </blockquote>
            </div>
      ...
      >
        ...
        >
          ...
          <span class="block">Klaar voor een samenwerking?</span>
          <span class="block">Start met een kennismaking!</span>
        </h2>
      </div>
      ...
      <div class="bg-white pb-16 sm:pb-24">
        <div class="relative sm:py-16">
          <div aria-hidden="true" class="hidden sm:block">
            <div
              class="absolute inset-y-0 left-0 w-1/2 bg-gray-100 rounded-r-3xl"
            ></div>
          </div>
          <div
          ...
          >
            <div
              class="relative rounded-2xl px-6 py-10 bg-gradient overflow-hidden shadow-xl sm:px-12 sm:py-20"
            >
              <div
                aria-hidden="true"
              ...
              >
                ...
                >
                  <path
                    class="text-gray-300 text-opacity-40"
                    fill="currentColor"
