...
<div class="relative overflow-hidden">
      <main>
        <div
          class="pt-10 bg-tertiary sm:pt-16 lg:pt-8 md:pb-4 lg:pb-14 overflow-hidden"
        >
              ...
              >
                <div class="lg:py-24">
                  ...
                  >
                    ...
                    <span
                      class="bg-clip-text text-transparent bg-gradient-to-r from-primary to-secondary block"
                      >develop</span
                    >
                  </h1>
                  <p
        ...
        <div class="relative py-16 sm:py-24 lg:py-32">
          ...
          >
            <h2
              class="text-base font-semibold tracking-wider text-primary-dark uppercase"
            >
              Deploy faster
            </h2>
            <p
                ...
                <div class="pt-6">
                  <div class="flow-root bg-gray-50 rounded-lg px-6 pb-8">
                    <div class="-mt-6">
                      <div>
                        <span
                          class="inline-flex items-center justify-center p-3 bg-gradient-to-r from-primary to-secondary rounded-md shadow-lg"
                        >
        ...
        <!-- Testimonial section -->
        <div
          class="pb-16 bg-gradient-to-r from-primary to-secondary lg:pb-0 lg:z-10 lg:relative"
        >
          <div
        ...
        <!-- Contact section -->
        <div
          class="bg-tertiary py-8 px-4 overflow-hidden sm:px-6 lg:px-8 lg:py-12"
        >
                ...
                <div class="flex items-start">
                  ...
                  <div class="ml-3">
                    <p class="text-base text-white">
                      ...
                      <a href="#" class="font-medium text-secondary underline"
                        >Privacy Policy</a
                      >
                      and
                      <a href="#" class="font-medium text-secondary underline"
